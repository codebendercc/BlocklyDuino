...
},{"./../../tools/client-util":23,"./../common/config":2,"./../common/rpc-args":3}],2:[function(require,module,exports){
...
},{"./parts.min":9}],5:[function(require,module,exports){
...
},{"./logging":8,"./util":19}],6:[function(require,module,exports){
module.exports = {
  UNKNOWN_ERROR: 1,
...
},{"./protocols/butterfly":11,"./protocols/stk500":14,"./protocols/stk500v2":15,"./protocols/usbtiny":16}],11:[function(require,module,exports){
...
},{"./../buffer":5,"./../errno":6,"./../logging":8,"./../util":19,"./serialtransaction":13}],12:[function(require,module,exports){
var util = require('./../util');
...
},{"./../../../chrome-extension/client/rpc-client":1,"./../buffer":5,"./../errno":6,"./../transaction":18,"./../util":19,"./memops":12}],14:[function(require,module,exports){
var SerialTransaction = require('./serialtransaction'),
    Log = require('./../logging').Log,
    log = new Log('STK500'),
    arraify = require('./../util').arraify,
...
STK500Transaction.prototype.programFlash = function (pgSize, dataOffset,
                                                     confirmPages) {
  var self = this, data = this.sketchData.data,
...
},{"./../buffer.js":5,"./../errno":6,"./../logging":8,"./../util":19,"./serialtransaction":13}],15:[function(require,module,exports){
...
},{"./../buffer":5,"./../errno":6,"./../logging":8,"./../util":19,"./memops":12,"./serialtransaction":13}],16:[function(require,module,exports){
...
},{"./../../../chrome-extension/client/rpc-client":1,"./../buffer":5,"./../logging":8,"./../util":19,"./memops":12,"./usbtransaction":17}],17:[function(require,module,exports){
var _create_chrome_client = require('./../../../chrome-extension/client/rpc-client'),
    Transaction = require('./../transaction').Transaction,
    arraify = require('./../util').arraify,
...
},{"./../../../chrome-extension/client/rpc-client":1,"./../buffer":5,"./../logging":8,"./../transaction":18,"./../util":19,"./memops":12}],18:[function(require,module,exports){
...
},{"./buffer":5,"./errno":6,"./logging":8,"./protocols/memops":12,"./util":19}],19:[function(require,module,exports){
...
if (!window.CodebenderPlugin) {
  console.warn("No chrome app.");
}

},{"./../chrome-extension/client/rpc-client":1,"./chrome-plugin":21}],21:[function(require,module,exports){
...
},{"./backend/avrdudeconf":4,"./backend/errno":6,"./backend/hexparser":7,"./backend/protocols":10,"./backend/util":19,"./serialmonitor":22}],22:[function(require,module,exports){
// file: chrome-plugin.js
...
},{"./backend/errno":6,"./backend/logging":8,"./backend/util":19}],23:[function(require,module,exports){
